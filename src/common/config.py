...
Two manifests, two sets of functions that share the same pattern:
  ...
  * the universe manifest      (config/securities_universe.yaml) - load_securities_universe / read_constituents
...
# ---------------------------------------------------------------------------
# Security-selection layer: the cross-sectional universe (config/securities_universe.yaml)
# plus its committed constituents CSV. Distinct from load_securities above, which is the
# macro equity watchlist.
# ---------------------------------------------------------------------------
